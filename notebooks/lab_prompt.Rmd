...
```
Our polynomial model performs well in sample, but does appears to underpredict out of sample. The model does not perform better than the ARIMA model out of sample.
