...
ggplot(aes(x = year_week, y = average)) +
  geom_line() +
  geom_line(aes(y = predict(mod.poly.season)), color = "FOUNDERS_ROCK") + #ran out of time but this isn't the same length as year_week so it's causing issues
