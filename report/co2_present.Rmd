...
```{r linear-compare, include=TRUE, fig.cap="Comparing Polynomial model predictions with actual data", fig.width=9, fig.height=3}
...
ggplot(co2_present, aes(x = year_week)) +
  geom_line(aes(y = average, colour = "Actual")) +
  geom_line(data = co2.Arima.predictions %>% filter(.model == "arima_fit_log")
