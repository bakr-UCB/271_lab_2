...
```{r NSA-residals, include=TRUE, fig.cap="NSA Trained ARIMA(,,)(,,)[12] Model Residuals", fig.width=9, fig.height=3}
co2_fit_present_NSA %>% 
  select(arima_fit_log.search) %>%
  gg_tsresiduals()
```
...
sa.plot + nsa.plot + plot_annotation(
  ...
  subtitle = "The NSA trained model outperofms the SA trained. However SA successfully captures the trend")
```
